...
var OlgaSpaWebSite;
(function (OlgaSpaWebSite) {
    var OlgaSpaModule;
    (function (OlgaSpaModule) {
        var TreatmentsDialog = (function (_super) {
            __extends(TreatmentsDialog, _super);
            function TreatmentsDialog() {
                _super.apply(this, arguments);
                this.form = new OlgaSpaModule.TreatmentsForm(this.idPrefix);
            }
            TreatmentsDialog.prototype.getFormKey = function () { return OlgaSpaModule.TreatmentsForm.formKey; };
            TreatmentsDialog.prototype.getIdProperty = function () { return OlgaSpaModule.TreatmentsRow.idProperty; };
            TreatmentsDialog.prototype.getLocalTextPrefix = function () { return OlgaSpaModule.TreatmentsRow.localTextPrefix; };
            TreatmentsDialog.prototype.getNameProperty = function () { return OlgaSpaModule.TreatmentsRow.nameProperty; };
            TreatmentsDialog.prototype.getService = function () { return OlgaSpaModule.TreatmentsService.baseUrl; };
            TreatmentsDialog = __decorate([
                Serenity.Decorators.registerClass(),
                Serenity.Decorators.responsive()
            ], TreatmentsDialog);
            return TreatmentsDialog;
        }(Serenity.EntityDialog));
        OlgaSpaModule.TreatmentsDialog = TreatmentsDialog;
    })(OlgaSpaModule = OlgaSpaWebSite.OlgaSpaModule || (OlgaSpaWebSite.OlgaSpaModule = {}));
})(OlgaSpaWebSite || (OlgaSpaWebSite = {}));
var OlgaSpaWebSite;
(function (OlgaSpaWebSite) {
    var OlgaSpaModule;
    (function (OlgaSpaModule) {
        var TreatmentsGrid = (function (_super) {
            __extends(TreatmentsGrid, _super);
            function TreatmentsGrid(container) {
                _super.call(this, container);
            }
            TreatmentsGrid.prototype.getColumnsKey = function () { return 'OlgaSpaModule.Treatments'; };
            TreatmentsGrid.prototype.getDialogType = function () { return OlgaSpaModule.TreatmentsDialog; };
            TreatmentsGrid.prototype.getIdProperty = function () { return OlgaSpaModule.TreatmentsRow.idProperty; };
            TreatmentsGrid.prototype.getLocalTextPrefix = function () { return OlgaSpaModule.TreatmentsRow.localTextPrefix; };
            TreatmentsGrid.prototype.getService = function () { return OlgaSpaModule.TreatmentsService.baseUrl; };
            TreatmentsGrid = __decorate([
                Serenity.Decorators.registerClass()
            ], TreatmentsGrid);
            return TreatmentsGrid;
        }(Serenity.EntityGrid));
        OlgaSpaModule.TreatmentsGrid = TreatmentsGrid;
    })(OlgaSpaModule = OlgaSpaWebSite.OlgaSpaModule || (OlgaSpaWebSite.OlgaSpaModule = {}));
})(OlgaSpaWebSite || (OlgaSpaWebSite = {}));
var OlgaSpaWebSite;
(function (OlgaSpaWebSite) {
    var OlgaSpaModule;
    (function (OlgaSpaModule) {
        var PackagesDialog = (function (_super) {
            __extends(PackagesDialog, _super);
            function PackagesDialog() {
                _super.apply(this, arguments);
                this.form = new OlgaSpaModule.PackagesForm(this.idPrefix);
            }
            PackagesDialog.prototype.getFormKey = function () { return OlgaSpaModule.PackagesForm.formKey; };
            PackagesDialog.prototype.getIdProperty = function () { return OlgaSpaModule.PackagesRow.idProperty; };
            PackagesDialog.prototype.getLocalTextPrefix = function () { return OlgaSpaModule.PackagesRow.localTextPrefix; };
            PackagesDialog.prototype.getNameProperty = function () { return OlgaSpaModule.PackagesRow.nameProperty; };
            PackagesDialog.prototype.getService = function () { return OlgaSpaModule.PackagesService.baseUrl; };
            PackagesDialog = __decorate([
                Serenity.Decorators.registerClass(),
                Serenity.Decorators.responsive()
            ], PackagesDialog);
            return PackagesDialog;
        }(Serenity.EntityDialog));
        OlgaSpaModule.PackagesDialog = PackagesDialog;
    })(OlgaSpaModule = OlgaSpaWebSite.OlgaSpaModule || (OlgaSpaWebSite.OlgaSpaModule = {}));
})(OlgaSpaWebSite || (OlgaSpaWebSite = {}));
var OlgaSpaWebSite;
(function (OlgaSpaWebSite) {
    var OlgaSpaModule;
    (function (OlgaSpaModule) {
        var PackagesGrid = (function (_super) {
            __extends(PackagesGrid, _super);
            function PackagesGrid(container) {
                _super.call(this, container);
            }
            PackagesGrid.prototype.getColumnsKey = function () { return 'OlgaSpaModule.Packages'; };
            PackagesGrid.prototype.getDialogType = function () { return OlgaSpaModule.PackagesDialog; };
            PackagesGrid.prototype.getIdProperty = function () { return OlgaSpaModule.PackagesRow.idProperty; };
            PackagesGrid.prototype.getLocalTextPrefix = function () { return OlgaSpaModule.PackagesRow.localTextPrefix; };
            PackagesGrid.prototype.getService = function () { return OlgaSpaModule.PackagesService.baseUrl; };
            PackagesGrid = __decorate([
                Serenity.Decorators.registerClass()
            ], PackagesGrid);
            return PackagesGrid;
        }(Serenity.EntityGrid));
        OlgaSpaModule.PackagesGrid = PackagesGrid;
    })(OlgaSpaModule = OlgaSpaWebSite.OlgaSpaModule || (OlgaSpaWebSite.OlgaSpaModule = {}));
})(OlgaSpaWebSite || (OlgaSpaWebSite = {}));
var OlgaSpaWebSite;
(function (OlgaSpaWebSite) {
    ...
    (function (OlgaSpaModule) {
        var CustomersDialog = (function (_super) {
            ...
            function CustomersDialog() {
                _super.apply(this, arguments);
                this.form = new OlgaSpaModule.CustomersForm(this.idPrefix);
            }
            CustomersDialog.prototype.getFormKey = function () { return OlgaSpaModule.CustomersForm.formKey; };
            CustomersDialog.prototype.getIdProperty = function () { return OlgaSpaModule.CustomersRow.idProperty; };
            CustomersDialog.prototype.getLocalTextPrefix = function () { return OlgaSpaModule.CustomersRow.localTextPrefix; };
            CustomersDialog.prototype.getNameProperty = function () { return OlgaSpaModule.CustomersRow.nameProperty; };
            CustomersDialog.prototype.getService = function () { return OlgaSpaModule.CustomersService.baseUrl; };
        ...
        OlgaSpaModule.CustomersDialog = CustomersDialog;
    })(OlgaSpaModule = OlgaSpaWebSite.OlgaSpaModule || (OlgaSpaWebSite.OlgaSpaModule = {}));
})(OlgaSpaWebSite || (OlgaSpaWebSite = {}));
var OlgaSpaWebSite;
(function (OlgaSpaWebSite) {
    ...
    (function (OlgaSpaModule) {
        var CustomersGrid = (function (_super) {
            ...
            CustomersGrid.prototype.getColumnsKey = function () { return 'OlgaSpaModule.Customers'; };
            CustomersGrid.prototype.getDialogType = function () { return OlgaSpaModule.CustomersDialog; };
            CustomersGrid.prototype.getIdProperty = function () { return OlgaSpaModule.CustomersRow.idProperty; };
            CustomersGrid.prototype.getLocalTextPrefix = function () { return OlgaSpaModule.CustomersRow.localTextPrefix; };
            CustomersGrid.prototype.getService = function () { return OlgaSpaModule.CustomersService.baseUrl; };
            CustomersGrid = __decorate([
                Serenity.Decorators.registerClass()
            ], CustomersGrid);
            return CustomersGrid;
        }(Serenity.EntityGrid));
        OlgaSpaModule.CustomersGrid = CustomersGrid;
    })(OlgaSpaModule = OlgaSpaWebSite.OlgaSpaModule || (OlgaSpaWebSite.OlgaSpaModule = {}));
})(OlgaSpaWebSite || (OlgaSpaWebSite = {}));
var OlgaSpaWebSite;
(function (OlgaSpaWebSite) {
    var OlgaSpaModule;
    (function (OlgaSpaModule) {
        var AppoinmentsDialog = (function (_super) {
            __extends(AppoinmentsDialog, _super);
            function AppoinmentsDialog() {
                _super.apply(this, arguments);
                this.form = new OlgaSpaModule.AppoinmentsForm(this.idPrefix);
            }
            AppoinmentsDialog.prototype.getFormKey = function () { return OlgaSpaModule.AppoinmentsForm.formKey; };
            AppoinmentsDialog.prototype.getIdProperty = function () { return OlgaSpaModule.AppoinmentsRow.idProperty; };
            AppoinmentsDialog.prototype.getLocalTextPrefix = function () { return OlgaSpaModule.AppoinmentsRow.localTextPrefix; };
            AppoinmentsDialog.prototype.getNameProperty = function () { return OlgaSpaModule.AppoinmentsRow.nameProperty; };
            AppoinmentsDialog.prototype.getService = function () { return OlgaSpaModule.AppoinmentsService.baseUrl; };
            AppoinmentsDialog = __decorate([
                Serenity.Decorators.registerClass(),
                Serenity.Decorators.responsive()
            ], AppoinmentsDialog);
            return AppoinmentsDialog;
        }(Serenity.EntityDialog));
        OlgaSpaModule.AppoinmentsDialog = AppoinmentsDialog;
    })(OlgaSpaModule = OlgaSpaWebSite.OlgaSpaModule || (OlgaSpaWebSite.OlgaSpaModule = {}));
})(OlgaSpaWebSite || (OlgaSpaWebSite = {}));
var OlgaSpaWebSite;
(function (OlgaSpaWebSite) {
    var OlgaSpaModule;
    (function (OlgaSpaModule) {
        var AppoinmentsGrid = (function (_super) {
            __extends(AppoinmentsGrid, _super);
            function AppoinmentsGrid(container) {
                _super.call(this, container);
            }
            AppoinmentsGrid.prototype.getColumnsKey = function () { return 'OlgaSpaModule.Appoinments'; };
            AppoinmentsGrid.prototype.getDialogType = function () { return OlgaSpaModule.AppoinmentsDialog; };
            AppoinmentsGrid.prototype.getIdProperty = function () { return OlgaSpaModule.AppoinmentsRow.idProperty; };
            AppoinmentsGrid.prototype.getLocalTextPrefix = function () { return OlgaSpaModule.AppoinmentsRow.localTextPrefix; };
            AppoinmentsGrid.prototype.getService = function () { return OlgaSpaModule.AppoinmentsService.baseUrl; };
            AppoinmentsGrid = __decorate([
                Serenity.Decorators.registerClass()
            ], AppoinmentsGrid);
            return AppoinmentsGrid;
        }(Serenity.EntityGrid));
        OlgaSpaModule.AppoinmentsGrid = AppoinmentsGrid;
    })(OlgaSpaModule = OlgaSpaWebSite.OlgaSpaModule || (OlgaSpaWebSite.OlgaSpaModule = {}));
})(OlgaSpaWebSite || (OlgaSpaWebSite = {}));
var OlgaSpaWebSite;
(function (OlgaSpaWebSite) {
    ...
    (function (Northwind) {
        var TerritoryDialog = (function (_super) {
            ...
            TerritoryDialog.prototype.getLanguages = function () {
                return OlgaSpaWebSite.LanguageList.getValue();
            };
    ...
    })(Northwind = OlgaSpaWebSite.Northwind || (OlgaSpaWebSite.Northwind = {}));
})(OlgaSpaWebSite || (OlgaSpaWebSite = {}));
var OlgaSpaWebSite;
(function (OlgaSpaWebSite) {
    var Northwind;
    ...
    (function (Northwind) {
        var ProductGrid = (function (_super) {
            ...
            ProductGrid.prototype.getButtons = function () {
                ...
                buttons.push(OlgaSpaWebSite.Common.ExcelExportHelper.createToolButton({
                    grid: this,
                    service: Northwind.ProductService.baseUrl + '/ListExcel',
                    onViewSubmit: function () { return _this.onViewSubmit(); },
                    separator: true
                }));
                buttons.push(OlgaSpaWebSite.Common.PdfExportHelper.createToolButton({
                    grid: this,
                    onViewSubmit: function () { return _this.onViewSubmit(); },
...
(function (OlgaSpaWebSite) {
    ...
    })(Common = OlgaSpaWebSite.Common || (OlgaSpaWebSite.Common = {}));
})(OlgaSpaWebSite || (OlgaSpaWebSite = {}));
...
(function (OlgaSpaWebSite) {
    ...
    (function (Northwind) {
        ...
        }(OlgaSpaWebSite.Common.GridEditorDialog));
...
(function (OlgaSpaWebSite) {
    ...
    (function (Northwind) {
        ...
        }(OlgaSpaWebSite.Common.GridEditorBase));
    ...
    (function (Common) {
        var BulkServiceAction = (function () {
            ...
            BulkServiceAction.prototype.createProgressDialog = function () {
                this.progressDialog = new OlgaSpaWebSite.BasicProgressDialog();
...
(function (OlgaSpaWebSite) {
    ...
    (function (BasicSamples) {
        ...
        }(OlgaSpaWebSite.Common.BulkServiceAction));
        BasicSamples.OrderBulkAction = OrderBulkAction;
    })(BasicSamples = OlgaSpaWebSite.BasicSamples || (OlgaSpaWebSite.BasicSamples = {}));
})(OlgaSpaWebSite || (OlgaSpaWebSite = {}));
var OlgaSpaWebSite;
(function (OlgaSpaWebSite) {
    var Northwind;
    (function (Northwind) {
        var OrderDialog = (function (_super) {
            ...
            OrderDialog.prototype.getToolbarButtons = function () {
                ...
                buttons.push(OlgaSpaWebSite.Common.ReportHelper.createToolButton({
                    title: 'Invoice',
            ...
            NotesEditor.prototype.addClick = function () {
                ...
                dlg.okClick = function () {
                    ...
                    Q.insert(_this.items, 0, {
                        Text: text,
                        InsertUserDisplayName: OlgaSpaWebSite.Authorization.userDefinition.DisplayName,
    ...
    (function (Northwind) {
        var CustomerDialog = (function (_super) {
            ...
            function CustomerDialog() {
                ...
                OlgaSpaWebSite.DialogUtils.pendingChangesConfirmation(this.element, function () { return _this.getSaveState() != _this.loadedState; });
...
(function (OlgaSpaWebSite) {
    ...
    })(Membership = OlgaSpaWebSite.Membership || (OlgaSpaWebSite.Membership = {}));
})(OlgaSpaWebSite || (OlgaSpaWebSite = {}));
var OlgaSpaWebSite;
(function (OlgaSpaWebSite) {
    var Membership;
...
(function (OlgaSpaWebSite) {
    ...
    (function (ScriptInitialization) {
        ...
        Q.Config.rootNamespaces.push('OlgaSpaWebSite');
    })(ScriptInitialization = OlgaSpaWebSite.ScriptInitialization || (OlgaSpaWebSite.ScriptInitialization = {}));
})(OlgaSpaWebSite || (OlgaSpaWebSite = {}));
var OlgaSpaWebSite;
(function (OlgaSpaWebSite) {
    var Common;
...
(function (OlgaSpaWebSite) {
    ...
    })(Administration = OlgaSpaWebSite.Administration || (OlgaSpaWebSite.Administration = {}));
})(OlgaSpaWebSite || (OlgaSpaWebSite = {}));
var OlgaSpaWebSite;
(function (OlgaSpaWebSite) {
    var Administration;
...
(function (OlgaSpaWebSite) {
    ...
    (function (BasicSamples) {
        ...
        [['CustomerID', function () { return OlgaSpaWebSite.Northwind.CustomerEditor; }], ['OrderDate', function () { return Serenity.DateEditor; }], ['CategoryID', function () { return Serenity.LookupEditor; }], ['DetailList', function () { return BasicSamples.FilteredLookupDetailEditor; }]].forEach(function (x) { return Object.defineProperty(FilteredLookupInDetailForm.prototype, x[0], { get: function () { return this.w(x[0], x[1]()); }, enumerable: true, configurable: true }); });
    })(BasicSamples = OlgaSpaWebSite.BasicSamples || (OlgaSpaWebSite.BasicSamples = {}));
})(OlgaSpaWebSite || (OlgaSpaWebSite = {}));
var OlgaSpaWebSite;
(function (OlgaSpaWebSite) {
...
(function (OlgaSpaWebSite) {
    ...
    (function (BasicSamples) {
        ...
        [['CustomerID', function () { return OlgaSpaWebSite.Northwind.CustomerEditor; }], ['CustomerContactName', function () { return Serenity.StringEditor; }], ['CustomerContactTitle', function () { return Serenity.StringEditor; }], ['CustomerCity', function () { return Serenity.StringEditor; }], ['CustomerRegion', function () { return Serenity.StringEditor; }], ['CustomerCountry', function () { return Serenity.StringEditor; }], ['CustomerPhone', function () { return Serenity.StringEditor; }], ['CustomerFax', function () { return Serenity.StringEditor; }], ['OrderDate', function () { return Serenity.DateEditor; }], ['RequiredDate', function () { return Serenity.DateEditor; }], ['EmployeeID', function () { return Serenity.LookupEditor; }], ['DetailList', function () { return OlgaSpaWebSite.Northwind.OrderDetailsEditor; }]].forEach(function (x) { return Object.defineProperty(PopulateLinkedDataForm.prototype, x[0], { get: function () { return this.w(x[0], x[1]()); }, enumerable: true, configurable: true }); });
    })(BasicSamples = OlgaSpaWebSite.BasicSamples || (OlgaSpaWebSite.BasicSamples = {}));
})(OlgaSpaWebSite || (OlgaSpaWebSite = {}));
var OlgaSpaWebSite;
(function (OlgaSpaWebSite) {
...
(function (OlgaSpaWebSite) {
    ...
    (function (Northwind) {
        ...
        Serenity.Decorators.registerEnum(Gender, 'OlgaSpaWebSite.Northwind.Entities.Gender');
    })(Northwind = OlgaSpaWebSite.Northwind || (OlgaSpaWebSite.Northwind = {}));
})(OlgaSpaWebSite || (OlgaSpaWebSite = {}));
var OlgaSpaWebSite;
(function (OlgaSpaWebSite) {
...
(function (OlgaSpaWebSite) {
    var OlgaSpaModule;
    (function (OlgaSpaModule) {
        var AppoinmentsForm = (function (_super) {
            __extends(AppoinmentsForm, _super);
            function AppoinmentsForm() {
                _super.apply(this, arguments);
            }
            AppoinmentsForm.formKey = 'OlgaSpaModule.Appoinments';
            return AppoinmentsForm;
        }(Serenity.PrefixedContext));
        OlgaSpaModule.AppoinmentsForm = AppoinmentsForm;
        [['IdCustomer', function () { return Serenity.LookupEditor; }], ['IdPackage', function () { return Serenity.StringEditor; }], ['IdTreatment', function () { return Serenity.IntegerEditor; }], ['StartDateDteAppointment', function () { return Serenity.DateEditor; }], ['EndDateDteAppointment', function () { return Serenity.DateEditor; }], ['DescriptionAppoinment', function () { return Serenity.StringEditor; }]].forEach(function (x) { return Object.defineProperty(AppoinmentsForm.prototype, x[0], { get: function () { return this.w(x[0], x[1]()); }, enumerable: true, configurable: true }); });
    })(OlgaSpaModule = OlgaSpaWebSite.OlgaSpaModule || (OlgaSpaWebSite.OlgaSpaModule = {}));
})(OlgaSpaWebSite || (OlgaSpaWebSite = {}));
var OlgaSpaWebSite;
(function (OlgaSpaWebSite) {
    ...
    (function (OlgaSpaModule) {
        var AppoinmentsRow;
        (function (AppoinmentsRow) {
            AppoinmentsRow.idProperty = 'IdAppointment';
            AppoinmentsRow.nameProperty = 'DescriptionAppoinment';
            AppoinmentsRow.localTextPrefix = 'OlgaSpaModule.Appoinments';
            var Fields;
            (function (Fields) {
            })(Fields = AppoinmentsRow.Fields || (AppoinmentsRow.Fields = {}));
            ['IdAppointment', 'IdCustomer', 'IdPackage', 'IdTreatment', 'StartDateDteAppointment', 'EndDateDteAppointment', 'DescriptionAppoinment'].forEach(function (x) { return Fields[x] = x; });
        })(AppoinmentsRow = OlgaSpaModule.AppoinmentsRow || (OlgaSpaModule.AppoinmentsRow = {}));
    })(OlgaSpaModule = OlgaSpaWebSite.OlgaSpaModule || (OlgaSpaWebSite.OlgaSpaModule = {}));
})(OlgaSpaWebSite || (OlgaSpaWebSite = {}));
var OlgaSpaWebSite;
(function (OlgaSpaWebSite) {
    var OlgaSpaModule;
    (function (OlgaSpaModule) {
        var AppoinmentsService;
        (function (AppoinmentsService) {
            AppoinmentsService.baseUrl = 'OlgaSpaModule/Appoinments';
            var Methods;
            (function (Methods) {
            })(Methods = AppoinmentsService.Methods || (AppoinmentsService.Methods = {}));
            ['Create', 'Update', 'Delete', 'Retrieve', 'List'].forEach(function (x) {
                AppoinmentsService[x] = function (r, s, o) { return Q.serviceRequest(AppoinmentsService.baseUrl + '/' + x, r, s, o); };
                Methods[x] = AppoinmentsService.baseUrl + '/' + x;
            });
        })(AppoinmentsService = OlgaSpaModule.AppoinmentsService || (OlgaSpaModule.AppoinmentsService = {}));
    })(OlgaSpaModule = OlgaSpaWebSite.OlgaSpaModule || (OlgaSpaWebSite.OlgaSpaModule = {}));
})(OlgaSpaWebSite || (OlgaSpaWebSite = {}));
var OlgaSpaWebSite;
(function (OlgaSpaWebSite) {
    ...
    (function (OlgaSpaModule) {
        var CustomersForm = (function (_super) {
            ...
            CustomersForm.formKey = 'OlgaSpaModule.Customers';
            return CustomersForm;
        }(Serenity.PrefixedContext));
        OlgaSpaModule.CustomersForm = CustomersForm;
        [['FirstNameCustomer', function () { return Serenity.StringEditor; }], ['LastNameCustomer', function () { return Serenity.StringEditor; }], ['Email', function () { return Serenity.EmailEditor; }], ['Address', function () { return Serenity.StringEditor; }], ['ContactNumber1', function () { return Serenity.StringEditor; }], ['ContactNumber2', function () { return Serenity.StringEditor; }], ['Country', function () { return Serenity.StringEditor; }], ['City', function () { return Serenity.StringEditor; }], ['RegistrationDate', function () { return Serenity.DateEditor; }], ['ModificationDate', function () { return Serenity.DateEditor; }]].forEach(function (x) { return Object.defineProperty(CustomersForm.prototype, x[0], { get: function () { return this.w(x[0], x[1]()); }, enumerable: true, configurable: true }); });
    })(OlgaSpaModule = OlgaSpaWebSite.OlgaSpaModule || (OlgaSpaWebSite.OlgaSpaModule = {}));
})(OlgaSpaWebSite || (OlgaSpaWebSite = {}));
var OlgaSpaWebSite;
(function (OlgaSpaWebSite) {
    ...
    (function (OlgaSpaModule) {
        ...
        (function (CustomersRow) {
            CustomersRow.idProperty = 'IdCustomer';
            CustomersRow.nameProperty = 'FirstNameCustomer';
            CustomersRow.localTextPrefix = 'OlgaSpaModule.Customers';
            CustomersRow.lookupKey = 'OlgaSpaModule.Customers';
            function getLookup() {
                return Q.getLookup('OlgaSpaModule.Customers');
            }
            CustomersRow.getLookup = getLookup;
            var Fields;
            (function (Fields) {
            })(Fields = CustomersRow.Fields || (CustomersRow.Fields = {}));
            ['IdCustomer', 'FirstNameCustomer', 'LastNameCustomer', 'Email', 'Address', 'ContactNumber1', 'ContactNumber2', 'Country', 'City', 'RegistrationDate', 'ModificationDate'].forEach(function (x) { return Fields[x] = x; });
        })(CustomersRow = OlgaSpaModule.CustomersRow || (OlgaSpaModule.CustomersRow = {}));
    })(OlgaSpaModule = OlgaSpaWebSite.OlgaSpaModule || (OlgaSpaWebSite.OlgaSpaModule = {}));
})(OlgaSpaWebSite || (OlgaSpaWebSite = {}));
var OlgaSpaWebSite;
(function (OlgaSpaWebSite) {
    ...
    (function (OlgaSpaModule) {
        ...
        (function (CustomersService) {
            CustomersService.baseUrl = 'OlgaSpaModule/Customers';
            var Methods;
            (function (Methods) {
        ...
        })(CustomersService = OlgaSpaModule.CustomersService || (OlgaSpaModule.CustomersService = {}));
    })(OlgaSpaModule = OlgaSpaWebSite.OlgaSpaModule || (OlgaSpaWebSite.OlgaSpaModule = {}));
})(OlgaSpaWebSite || (OlgaSpaWebSite = {}));
var OlgaSpaWebSite;
(function (OlgaSpaWebSite) {
    var OlgaSpaModule;
    (function (OlgaSpaModule) {
        var PackagesForm = (function (_super) {
            __extends(PackagesForm, _super);
            function PackagesForm() {
                _super.apply(this, arguments);
            }
            PackagesForm.formKey = 'OlgaSpaModule.Packages';
            return PackagesForm;
        }(Serenity.PrefixedContext));
        OlgaSpaModule.PackagesForm = PackagesForm;
        [['DescriptionPackage', function () { return Serenity.StringEditor; }], ['SuggestedCost', function () { return Serenity.DecimalEditor; }], ['Sessions', function () { return Serenity.IntegerEditor; }]].forEach(function (x) { return Object.defineProperty(PackagesForm.prototype, x[0], { get: function () { return this.w(x[0], x[1]()); }, enumerable: true, configurable: true }); });
    })(OlgaSpaModule = OlgaSpaWebSite.OlgaSpaModule || (OlgaSpaWebSite.OlgaSpaModule = {}));
})(OlgaSpaWebSite || (OlgaSpaWebSite = {}));
var OlgaSpaWebSite;
(function (OlgaSpaWebSite) {
    ...
    (function (OlgaSpaModule) {
        var PackagesRow;
        (function (PackagesRow) {
            PackagesRow.idProperty = 'IdPackage';
            PackagesRow.nameProperty = 'DescriptionPackage';
            PackagesRow.localTextPrefix = 'OlgaSpaModule.Packages';
            var Fields;
            (function (Fields) {
            })(Fields = PackagesRow.Fields || (PackagesRow.Fields = {}));
            ['IdPackage', 'DescriptionPackage', 'SuggestedCost', 'Sessions'].forEach(function (x) { return Fields[x] = x; });
        })(PackagesRow = OlgaSpaModule.PackagesRow || (OlgaSpaModule.PackagesRow = {}));
    })(OlgaSpaModule = OlgaSpaWebSite.OlgaSpaModule || (OlgaSpaWebSite.OlgaSpaModule = {}));
})(OlgaSpaWebSite || (OlgaSpaWebSite = {}));
var OlgaSpaWebSite;
(function (OlgaSpaWebSite) {
    ...
    (function (OlgaSpaModule) {
        ...
        (function (PackagesService) {
            PackagesService.baseUrl = 'OlgaSpaModule/Packages';
            var Methods;
            (function (Methods) {
            })(Methods = PackagesService.Methods || (PackagesService.Methods = {}));
            ['Create', 'Update', 'Delete', 'Retrieve', 'List'].forEach(function (x) {
                PackagesService[x] = function (r, s, o) { return Q.serviceRequest(PackagesService.baseUrl + '/' + x, r, s, o); };
                Methods[x] = PackagesService.baseUrl + '/' + x;
            });
        })(PackagesService = OlgaSpaModule.PackagesService || (OlgaSpaModule.PackagesService = {}));
    })(OlgaSpaModule = OlgaSpaWebSite.OlgaSpaModule || (OlgaSpaWebSite.OlgaSpaModule = {}));
})(OlgaSpaWebSite || (OlgaSpaWebSite = {}));
var OlgaSpaWebSite;
(function (OlgaSpaWebSite) {
    var OlgaSpaModule;
    (function (OlgaSpaModule) {
        var TreatmentsForm = (function (_super) {
            __extends(TreatmentsForm, _super);
            function TreatmentsForm() {
                _super.apply(this, arguments);
            }
            TreatmentsForm.formKey = 'OlgaSpaModule.Treatments';
            return TreatmentsForm;
        }(Serenity.PrefixedContext));
        OlgaSpaModule.TreatmentsForm = TreatmentsForm;
        [['DescriptionTreatment', function () { return Serenity.StringEditor; }]].forEach(function (x) { return Object.defineProperty(TreatmentsForm.prototype, x[0], { get: function () { return this.w(x[0], x[1]()); }, enumerable: true, configurable: true }); });
    })(OlgaSpaModule = OlgaSpaWebSite.OlgaSpaModule || (OlgaSpaWebSite.OlgaSpaModule = {}));
})(OlgaSpaWebSite || (OlgaSpaWebSite = {}));
var OlgaSpaWebSite;
(function (OlgaSpaWebSite) {
    ...
    (function (OlgaSpaModule) {
        var TreatmentsRow;
        (function (TreatmentsRow) {
            TreatmentsRow.idProperty = 'IdTreatment';
            TreatmentsRow.nameProperty = 'DescriptionTreatment';
            TreatmentsRow.localTextPrefix = 'OlgaSpaModule.Treatments';
            var Fields;
            (function (Fields) {
            })(Fields = TreatmentsRow.Fields || (TreatmentsRow.Fields = {}));
            ['IdTreatment', 'DescriptionTreatment'].forEach(function (x) { return Fields[x] = x; });
        })(TreatmentsRow = OlgaSpaModule.TreatmentsRow || (OlgaSpaModule.TreatmentsRow = {}));
    })(OlgaSpaModule = OlgaSpaWebSite.OlgaSpaModule || (OlgaSpaWebSite.OlgaSpaModule = {}));
})(OlgaSpaWebSite || (OlgaSpaWebSite = {}));
var OlgaSpaWebSite;
(function (OlgaSpaWebSite) {
    ...
    (function (OlgaSpaModule) {
        ...
        (function (TreatmentsService) {
            TreatmentsService.baseUrl = 'OlgaSpaModule/Treatments';
            var Methods;
            (function (Methods) {
            })(Methods = TreatmentsService.Methods || (TreatmentsService.Methods = {}));
            ['Create', 'Update', 'Delete', 'Retrieve', 'List'].forEach(function (x) {
                TreatmentsService[x] = function (r, s, o) { return Q.serviceRequest(TreatmentsService.baseUrl + '/' + x, r, s, o); };
                Methods[x] = TreatmentsService.baseUrl + '/' + x;
            });
        })(TreatmentsService = OlgaSpaModule.TreatmentsService || (OlgaSpaModule.TreatmentsService = {}));
    })(OlgaSpaModule = OlgaSpaWebSite.OlgaSpaModule || (OlgaSpaWebSite.OlgaSpaModule = {}));
})(OlgaSpaWebSite || (OlgaSpaWebSite = {}));
var OlgaSpaWebSite;
(function (OlgaSpaWebSite) {
    ...
    OlgaSpaWebSite.BasicProgressDialog = BasicProgressDialog;
})(OlgaSpaWebSite || (OlgaSpaWebSite = {}));
var OlgaSpaWebSite;
(function (OlgaSpaWebSite) {
    var DialogUtils;
    ...
    })(DialogUtils = OlgaSpaWebSite.DialogUtils || (OlgaSpaWebSite.DialogUtils = {}));
})(OlgaSpaWebSite || (OlgaSpaWebSite = {}));
var OlgaSpaWebSite;
(function (OlgaSpaWebSite) {
    var Common;
...
(function (OlgaSpaWebSite) {
    ...
    (function (LanguageList) {
        function getValue() {
            var result = [];
            for (var _i = 0, _a = OlgaSpaWebSite.Administration.LanguageRow.getLookup().items; _i < _a.length; _i++) {
                var k = _a[_i];
                if (k.LanguageId !== 'en') {
    ...
    })(LanguageList = OlgaSpaWebSite.LanguageList || (OlgaSpaWebSite.LanguageList = {}));
})(OlgaSpaWebSite || (OlgaSpaWebSite = {}));
var OlgaSpaWebSite;
(function (OlgaSpaWebSite) {
    var Common;
...
(function (OlgaSpaWebSite) {
    ...
    (function (BasicSamples) {
        var ViewWithoutIDGrid = (function (_super) {
            ...
            ViewWithoutIDGrid.prototype.getNameProperty = function () { return OlgaSpaWebSite.Northwind.SalesByCategoryRow.nameProperty; };
            ViewWithoutIDGrid.prototype.getLocalTextPrefix = function () { return OlgaSpaWebSite.Northwind.SalesByCategoryRow.localTextPrefix; };
            ViewWithoutIDGrid.prototype.getService = function () { return OlgaSpaWebSite.Northwind.SalesByCategoryService.baseUrl; };
            /**
...
(function (OlgaSpaWebSite) {
    ...
    (function (BasicSamples) {
        ...
        }(OlgaSpaWebSite.Northwind.SupplierGrid));
...
(function (OlgaSpaWebSite) {
    ...
    (function (BasicSamples) {
        ...
        }(OlgaSpaWebSite.Northwind.ProductGrid));
...
(function (OlgaSpaWebSite) {
    ...
    (function (BasicSamples) {
        var InlineImageInGrid = (function (_super) {
            ...
            InlineImageInGrid.prototype.getDialogType = function () { return OlgaSpaWebSite.Northwind.ProductDialog; };
            InlineImageInGrid.prototype.getIdProperty = function () { return OlgaSpaWebSite.Northwind.ProductRow.idProperty; };
            InlineImageInGrid.prototype.getLocalTextPrefix = function () { return OlgaSpaWebSite.Northwind.ProductRow.localTextPrefix; };
            InlineImageInGrid.prototype.getService = function () { return OlgaSpaWebSite.Northwind.ProductService.baseUrl; };
    ...
    (function (BasicSamples) {
        var InitialValuesForQuickFilters = (function (_super) {
            ...
            InitialValuesForQuickFilters.prototype.getQuickFilters = function () {
                ...
                var fld = OlgaSpaWebSite.Northwind.OrderRow.Fields;
                ...
                Q.first(filters, function (x) { return x.field == fld.ShippingState; }).init = function (w) {
                    ...
                    w.value = OlgaSpaWebSite.Northwind.OrderShippingState.NotShipped.toString();
                };
                return filters;
            };
            /**
        ...
        }(OlgaSpaWebSite.Northwind.OrderGrid));
            ...
            CustomLinksInGrid.prototype.onClick = function (e, row, cell) {
                ...
                if (target.hasClass("customer-link")) {
                    ...
                    Q.confirm(message, function () {
                        ...
                        var customer = Q.first(OlgaSpaWebSite.Northwind.CustomerRow.getLookup().items, function (x) { return x.CustomerID == item.CustomerID; });
                        new OlgaSpaWebSite.Northwind.CustomerDialog().loadByIdAndOpenDialog(customer.ID);
                    }, {
                        htmlEncode: false,
                        onNo: function () {
                            new OlgaSpaWebSite.Northwind.OrderDialog().loadByIdAndOpenDialog(item.OrderID);
                        }
                    });
                }
                    ...
                    new OlgaSpaWebSite.Northwind.OrderDialog().loadEntityAndOpenDialog({
                    ...
                    var countryFilter = this.findQuickFilter(Serenity.LookupEditor, OlgaSpaWebSite.Northwind.OrderRow.Fields.ShipCountry);
...
(function (OlgaSpaWebSite) {
    ...
    (function (BasicSamples) {
        var ConditionalFormattingGrid = (function (_super) {
            ...
            ConditionalFormattingGrid.prototype.getDialogType = function () { return OlgaSpaWebSite.Northwind.ProductDialog; };
            ConditionalFormattingGrid.prototype.getIdProperty = function () { return OlgaSpaWebSite.Northwind.ProductRow.idProperty; };
            ConditionalFormattingGrid.prototype.getLocalTextPrefix = function () { return OlgaSpaWebSite.Northwind.ProductRow.localTextPrefix; };
            ConditionalFormattingGrid.prototype.getService = function () { return OlgaSpaWebSite.Northwind.ProductService.baseUrl; };
            /**
            ...
            ConditionalFormattingGrid.prototype.getColumns = function () {
                var columns = _super.prototype.getColumns.call(this);
                var fld = OlgaSpaWebSite.Northwind.ProductRow.Fields;
...
(function (OlgaSpaWebSite) {
    ...
    (function (BasicSamples) {
        ...
        }(OlgaSpaWebSite.Northwind.ProductDialog));
    ...
    (function (BasicSamples) {
        ...
        var ProduceSeafoodCategoryEditor = (function (_super) {
            ...
            ProduceSeafoodCategoryEditor.prototype.getLookupKey = function () {
                return OlgaSpaWebSite.Northwind.CategoryRow.lookupKey;
            };
            /**
...
(function (OlgaSpaWebSite) {
    ...
    (function (BasicSamples) {
        ...
        }(OlgaSpaWebSite.Northwind.OrderDetailsEditor));
...
(function (OlgaSpaWebSite) {
    ...
    (function (BasicSamples) {
        ...
        var FilteredLookupInDetailDialog = (function (_super) {
            ...
            FilteredLookupInDetailDialog.prototype.getIdProperty = function () { return OlgaSpaWebSite.Northwind.OrderRow.idProperty; };
            FilteredLookupInDetailDialog.prototype.getLocalTextPrefix = function () { return OlgaSpaWebSite.Northwind.OrderRow.localTextPrefix; };
            FilteredLookupInDetailDialog.prototype.getNameProperty = function () { return OlgaSpaWebSite.Northwind.OrderRow.nameProperty; };
            FilteredLookupInDetailDialog.prototype.getService = function () { return OlgaSpaWebSite.Northwind.OrderService.baseUrl; };
    ...
    (function (BasicSamples) {
        ...
        var FilteredLookupOrderDetailDialog = (function (_super) {
            ...
            function FilteredLookupOrderDetailDialog() {
                _super.call(this);
                this.form = new OlgaSpaWebSite.Northwind.OrderDetailForm(this.idPrefix);
                ...
                this.form.ProductID.cascadeField = OlgaSpaWebSite.Northwind.ProductRow.Fields.CategoryID;
        ...
        }(OlgaSpaWebSite.Northwind.OrderDetailDialog));
...
(function (OlgaSpaWebSite) {
    ...
    (function (BasicSamples) {
        var SerialAutoNumberDialog = (function (_super) {
            ...
            SerialAutoNumberDialog.prototype.getNextNumber = function () {
                ...
                if (!val || val.length <= 1) {
                    ...
                    OlgaSpaWebSite.Northwind.CustomerService.GetNextNumber({
                        Prefix: prefix,
        ...
        }(OlgaSpaWebSite.Northwind.CustomerDialog));
...
(function (OlgaSpaWebSite) {
    ...
    (function (BasicSamples) {
        ...
        }(OlgaSpaWebSite.Northwind.CustomerGrid));
...
(function (OlgaSpaWebSite) {
    ...
    (function (BasicSamples) {
        ...
        var ResponsiveDialog = (function (_super) {
            ...
            ResponsiveDialog.prototype.getFormKey = function () { return OlgaSpaWebSite.Northwind.OrderForm.formKey; };
            ResponsiveDialog.prototype.getIdProperty = function () { return OlgaSpaWebSite.Northwind.OrderRow.idProperty; };
            ResponsiveDialog.prototype.getLocalTextPrefix = function () { return OlgaSpaWebSite.Northwind.OrderRow.localTextPrefix; };
            ResponsiveDialog.prototype.getNameProperty = function () { return OlgaSpaWebSite.Northwind.OrderRow.nameProperty; };
            ResponsiveDialog.prototype.getService = function () { return OlgaSpaWebSite.Northwind.OrderService.baseUrl; };
...
(function (OlgaSpaWebSite) {
    ...
    (function (BasicSamples) {
        ...
        }(OlgaSpaWebSite.Northwind.SupplierDialog));
        ...
        var PopulateLinkedDataDialog = (function (_super) {
            ...
            function PopulateLinkedDataDialog() {
                ...
                this.form.CustomerID.changeSelect2(function (e) {
                    ...
                    var id = Q.first(OlgaSpaWebSite.Northwind.CustomerRow.getLookup().items, function (x) { return x.CustomerID == customerID; }).ID;
                    OlgaSpaWebSite.Northwind.CustomerService.Retrieve({
                        EntityId: id
                    }, function (response) {
            ...
            PopulateLinkedDataDialog.prototype.getIdProperty = function () { return OlgaSpaWebSite.Northwind.OrderRow.idProperty; };
            PopulateLinkedDataDialog.prototype.getLocalTextPrefix = function () { return OlgaSpaWebSite.Northwind.OrderRow.localTextPrefix; };
            PopulateLinkedDataDialog.prototype.getNameProperty = function () { return OlgaSpaWebSite.Northwind.OrderRow.nameProperty; };
            PopulateLinkedDataDialog.prototype.getService = function () { return OlgaSpaWebSite.Northwind.OrderService.baseUrl; };
...
(function (OlgaSpaWebSite) {
    ...
    (function (BasicSamples) {
        ...
        }(OlgaSpaWebSite.Northwind.OrderDialog));
...
(function (OlgaSpaWebSite) {
    ...
    (function (BasicSamples) {
        var GetInsertedRecordIdDialog = (function (_super) {
            ...
            GetInsertedRecordIdDialog.prototype.onSaveSuccess = function (response) {
                ...
                if (this.isNew) {
                    ...
                    OlgaSpaWebSite.Northwind.CategoryService.Retrieve({
        ...
        }(OlgaSpaWebSite.Northwind.CategoryDialog));
...
(function (OlgaSpaWebSite) {
    ...
    (function (BasicSamples) {
        ...
        }(OlgaSpaWebSite.Northwind.CategoryGrid));
        ...
        var DefaultValuesInNewGrid = (function (_super) {
            ...
            DefaultValuesInNewGrid.prototype.addButtonClick = function () {
                this.editItem({
                    ...
                    EmployeeID: OlgaSpaWebSite.Northwind.EmployeeRow.getLookup().items
                        .filter(function (x) { return x.FullName === 'Robert King'; })[0].EmployeeID,
                    ShipVia: OlgaSpaWebSite.Northwind.ShipperRow.getLookup().items
            ...
            DefaultValuesInNewGrid.prototype.getButtons = function () {
                ...
                buttons.push({
                    ...
                    onClick: function () {
                        ...
                        var dlg = new OlgaSpaWebSite.Northwind.OrderDialog();
                        ...
                        var chai = OlgaSpaWebSite.Northwind.ProductRow.getLookup().items
                            .filter(function (x) { return x.ProductName === 'Chai'; })[0];
                        // LoadEntityAndOpenDialog, loads an OrderRow 
                        // to dialog and opens it
                        var lauraCallahanID = OlgaSpaWebSite.Northwind.EmployeeRow.getLookup().items
...
(function (OlgaSpaWebSite) {
    ...
    })(Authorization = OlgaSpaWebSite.Authorization || (OlgaSpaWebSite.Authorization = {}));
})(OlgaSpaWebSite || (OlgaSpaWebSite = {}));
var OlgaSpaWebSite;
(function (OlgaSpaWebSite) {
    var Administration;
...
//# sourceMappingURL=OlgaSpaWebSite.Web.js.map