declare namespace OlgaSpaWebSite.OlgaSpaModule {
    class TreatmentsDialog extends Serenity.EntityDialog<TreatmentsRow, any> {
        protected getFormKey(): string;
        protected getIdProperty(): string;
        protected getLocalTextPrefix(): string;
        protected getNameProperty(): string;
        protected getService(): string;
        protected form: TreatmentsForm;
    }
}
declare namespace OlgaSpaWebSite.OlgaSpaModule {
    class TreatmentsGrid extends Serenity.EntityGrid<TreatmentsRow, any> {
        protected getColumnsKey(): string;
        protected getDialogType(): typeof TreatmentsDialog;
        protected getIdProperty(): string;
        protected getLocalTextPrefix(): string;
        protected getService(): string;
...
declare namespace OlgaSpaWebSite.OlgaSpaModule {
    class PackagesDialog extends Serenity.EntityDialog<PackagesRow, any> {
        protected getFormKey(): string;
        protected getIdProperty(): string;
        protected getLocalTextPrefix(): string;
        protected getNameProperty(): string;
        protected getService(): string;
        protected form: PackagesForm;
    }
}
declare namespace OlgaSpaWebSite.OlgaSpaModule {
    class PackagesGrid extends Serenity.EntityGrid<PackagesRow, any> {
        protected getColumnsKey(): string;
        protected getDialogType(): typeof PackagesDialog;
        protected getIdProperty(): string;
        protected getLocalTextPrefix(): string;
        protected getService(): string;
        constructor(container: JQuery);
...
declare namespace OlgaSpaWebSite.OlgaSpaModule {
    class AppoinmentsDialog extends Serenity.EntityDialog<AppoinmentsRow, any> {
        protected getFormKey(): string;
        protected getIdProperty(): string;
        protected getLocalTextPrefix(): string;
        protected getNameProperty(): string;
        protected getService(): string;
        protected form: AppoinmentsForm;
    }
}
declare namespace OlgaSpaWebSite.OlgaSpaModule {
    class AppoinmentsGrid extends Serenity.EntityGrid<AppoinmentsRow, any> {
        protected getColumnsKey(): string;
        protected getDialogType(): typeof AppoinmentsDialog;
        protected getIdProperty(): string;
        protected getLocalTextPrefix(): string;
        protected getService(): string;
        constructor(container: JQuery);
...
declare namespace OlgaSpaWebSite.Northwind {
...
declare namespace OlgaSpaWebSite.Common {
...
declare namespace OlgaSpaWebSite.BasicSamples {
...
declare namespace OlgaSpaWebSite.Membership {
...
declare namespace OlgaSpaWebSite.ScriptInitialization {
}
declare namespace OlgaSpaWebSite.Common {
...
declare namespace OlgaSpaWebSite.Administration {
}
declare namespace OlgaSpaWebSite.Administration {
...
declare namespace OlgaSpaWebSite.Common.Pages {
...
declare namespace OlgaSpaWebSite {
...
declare namespace OlgaSpaWebSite.OlgaSpaModule {
    class AppoinmentsForm extends Serenity.PrefixedContext {
        static formKey: string;
    }
    interface AppoinmentsForm {
...
declare namespace OlgaSpaWebSite.OlgaSpaModule {
    ...
    namespace AppoinmentsRow {
        const idProperty: string;
        const nameProperty: string;
        const localTextPrefix: string;
        namespace Fields {
            const IdAppointment: string;
            const IdCustomer: string;
            const IdPackage: string;
            const IdTreatment: string;
            const StartDateDteAppointment: string;
            const EndDateDteAppointment: string;
            const DescriptionAppoinment: string;
        }
    }
}
declare namespace OlgaSpaWebSite.OlgaSpaModule {
    namespace AppoinmentsService {
        const baseUrl: string;
        function Create(request: Serenity.SaveRequest<AppoinmentsRow>, onSuccess?: (response: Serenity.SaveResponse) => void, opt?: Q.ServiceOptions<any>): JQueryXHR;
        function Update(request: Serenity.SaveRequest<AppoinmentsRow>, onSuccess?: (response: Serenity.SaveResponse) => void, opt?: Q.ServiceOptions<any>): JQueryXHR;
        function Delete(request: Serenity.DeleteRequest, onSuccess?: (response: Serenity.DeleteResponse) => void, opt?: Q.ServiceOptions<any>): JQueryXHR;
        function Retrieve(request: Serenity.RetrieveRequest, onSuccess?: (response: Serenity.RetrieveResponse<AppoinmentsRow>) => void, opt?: Q.ServiceOptions<any>): JQueryXHR;
        function List(request: Serenity.ListRequest, onSuccess?: (response: Serenity.ListResponse<AppoinmentsRow>) => void, opt?: Q.ServiceOptions<any>): JQueryXHR;
        namespace Methods {
            const Create: string;
            const Update: string;
            const Delete: string;
...
declare namespace OlgaSpaWebSite.OlgaSpaModule {
    ...
    namespace CustomersRow {
        ...
        namespace Fields {
            const IdCustomer: string;
            const FirstNameCustomer: string;
            const LastNameCustomer: string;
            const Email: string;
            const Address: string;
            const ContactNumber1: string;
            const ContactNumber2: string;
            const Country: string;
            const City: string;
            const RegistrationDate: string;
            const ModificationDate: string;
        }
    }
}
declare namespace OlgaSpaWebSite.OlgaSpaModule {
...
declare namespace OlgaSpaWebSite.OlgaSpaModule {
    class PackagesForm extends Serenity.PrefixedContext {
        static formKey: string;
    }
...
declare namespace OlgaSpaWebSite.OlgaSpaModule {
    ...
    namespace PackagesRow {
        const idProperty: string;
        const nameProperty: string;
        const localTextPrefix: string;
        namespace Fields {
            const IdPackage: string;
            const DescriptionPackage: string;
            const SuggestedCost: string;
            const Sessions: string;
        }
    }
}
declare namespace OlgaSpaWebSite.OlgaSpaModule {
    namespace PackagesService {
        const baseUrl: string;
        function Create(request: Serenity.SaveRequest<PackagesRow>, onSuccess?: (response: Serenity.SaveResponse) => void, opt?: Q.ServiceOptions<any>): JQueryXHR;
        function Update(request: Serenity.SaveRequest<PackagesRow>, onSuccess?: (response: Serenity.SaveResponse) => void, opt?: Q.ServiceOptions<any>): JQueryXHR;
        function Delete(request: Serenity.DeleteRequest, onSuccess?: (response: Serenity.DeleteResponse) => void, opt?: Q.ServiceOptions<any>): JQueryXHR;
        function Retrieve(request: Serenity.RetrieveRequest, onSuccess?: (response: Serenity.RetrieveResponse<PackagesRow>) => void, opt?: Q.ServiceOptions<any>): JQueryXHR;
        function List(request: Serenity.ListRequest, onSuccess?: (response: Serenity.ListResponse<PackagesRow>) => void, opt?: Q.ServiceOptions<any>): JQueryXHR;
        namespace Methods {
            const Create: string;
            const Update: string;
            const Delete: string;
...
declare namespace OlgaSpaWebSite.OlgaSpaModule {
    class TreatmentsForm extends Serenity.PrefixedContext {
        static formKey: string;
    }
    interface TreatmentsForm {
        DescriptionTreatment: Serenity.StringEditor;
    }
}
declare namespace OlgaSpaWebSite.OlgaSpaModule {
    interface TreatmentsRow {
        IdTreatment?: number;
        DescriptionTreatment?: string;
    }
    namespace TreatmentsRow {
        const idProperty: string;
        const nameProperty: string;
        const localTextPrefix: string;
        namespace Fields {
            const IdTreatment: string;
            const DescriptionTreatment: string;
        }
    }
}
declare namespace OlgaSpaWebSite.OlgaSpaModule {
    namespace TreatmentsService {
        const baseUrl: string;
        function Create(request: Serenity.SaveRequest<TreatmentsRow>, onSuccess?: (response: Serenity.SaveResponse) => void, opt?: Q.ServiceOptions<any>): JQueryXHR;
        function Update(request: Serenity.SaveRequest<TreatmentsRow>, onSuccess?: (response: Serenity.SaveResponse) => void, opt?: Q.ServiceOptions<any>): JQueryXHR;
        function Delete(request: Serenity.DeleteRequest, onSuccess?: (response: Serenity.DeleteResponse) => void, opt?: Q.ServiceOptions<any>): JQueryXHR;
        function Retrieve(request: Serenity.RetrieveRequest, onSuccess?: (response: Serenity.RetrieveResponse<TreatmentsRow>) => void, opt?: Q.ServiceOptions<any>): JQueryXHR;
        function List(request: Serenity.ListRequest, onSuccess?: (response: Serenity.ListResponse<TreatmentsRow>) => void, opt?: Q.ServiceOptions<any>): JQueryXHR;
        namespace Methods {
            const Create: string;
            const Update: string;
            const Delete: string;
...
declare namespace OlgaSpaWebSite.DialogUtils {
...
declare namespace OlgaSpaWebSite.LanguageList {
...
declare namespace OlgaSpaWebSite.BasicSamples.DialogBoxes {
...
declare namespace OlgaSpaWebSite.Authorization {
