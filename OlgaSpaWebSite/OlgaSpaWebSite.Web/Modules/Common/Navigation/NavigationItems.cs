...
using Northwind = OlgaSpaWebSite.Northwind.Pages;
using Administration = OlgaSpaWebSite.Administration.Pages;
using Basic = OlgaSpaWebSite.BasicSamples.Pages;
using Spa = OlgaSpaWebSite.OlgaSpaModule.Pages;

[assembly: NavigationLink(1000, "Dashboard", url: "~/", permission: "", icon: "icon-speedometer")]

[assembly: NavigationMenu(2000, "SPA Configuration", icon: "icon-screen-desktop")]
[assembly: NavigationLink(2100, "SPA Configuration/Customers", typeof(Spa.CustomersController), icon: "icon-people")]
[assembly: NavigationLink(2200, "SPA Configuration/Treatments", typeof(Spa.TreatmentsController), icon: "icon-wallet")]
[assembly: NavigationLink(2300, "SPA Configuration/Packages", typeof(Spa.PackagesController), icon: "icon-wallet")]
[assembly: NavigationLink(2400, "SPA Configuration/Appoinments", typeof(Spa.AppoinmentsController), icon: "icon-wallet")]
