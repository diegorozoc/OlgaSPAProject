...
namespace MVC
{
    public static class Views
    {
        ...
        public static class OlgaSpaModule
        {
            public static class Appoinments
            {
                public const string AppoinmentsIndex = "~/Modules/OlgaSpaModule/Appoinments/AppoinmentsIndex.cshtml";
            }

            public static class Customers
            {
                public const string CustomersIndex = "~/Modules/OlgaSpaModule/Customers/CustomersIndex.cshtml";
            }

            public static class Packages
            {
                public const string PackagesIndex = "~/Modules/OlgaSpaModule/Packages/PackagesIndex.cshtml";
            }

            public static class Treatments
            {
                public const string TreatmentsIndex = "~/Modules/OlgaSpaModule/Treatments/TreatmentsIndex.cshtml";
            }
        }
